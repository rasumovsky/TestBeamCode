...
bin/%	: obj/%.o obj/ChipDimension.o obj/PixelHit.o obj/PixelCluster.o obj/LinearMapMaker.o obj/ModuleMapping.o obj/MatchMaker.o obj/TreeFEI4.o obj/TreeT3MAPS.o obj/PlotUtil.o
